...
class CarDetails(enum.Enum):
    """
    Enum usage: When you write these functions, you do all of the typing for them in Python, so that the model
                knows what values to pass for the various parameters to these functions when it starts using it
                as a tool. 
    """
    VIN = "vin"
    Make = "make"
